...
var MAX_VIDEO_SIZE_BYTES = 500 * 1024 * 1024;
...
var FileUploader = function (params, twit) {
  ...
  self._forcedMediaCategory = params.media_category;
}
...
FileUploader.prototype._initMedia = function (cb) {
  ...
  if (mediaFileSizeBytes < maxSize) {
    self._twit.post('media/upload', {
      'command': 'INIT',
      'media_type': mediaType,
      'total_bytes': mediaFileSizeBytes,
      'shared': shared,
      'media_category': self._forcedMediaCategory || media_category
    }, cb);
  } else {
